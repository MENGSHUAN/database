...
switch (get_request_var('action')) {
	case 'unfollow':
		...
		$sql = "delete from followed_course where student_id = \"$student_id\" and course_id = \"$id\""; 
		...
		echo "已退關注課程 : " .  $course_name . "  " . " course_id : " . $id;
	...
	case 'follow':
		...
		$sql = "insert into followed_course (student_id,course_id) values(\"$student_id\", \"$id\")"; 
		...
		echo "已關注課程 : " .  $course_name . "  " . " course_id : " . $id;
