...
//		echo $sql;
 ...
 //           echo  "  " . $slot_id . "  " . $num1 . "  " . $day . "  " .     $key . "  ";   
            ...
            $table[$num1][$key][1] = $row['time_slot_id'];		// use to index to differnt color style
            
            $table[$num3][$key][0] = $row['course_name']; 
            $table[$num3][$key][1] = $row['time_slot_id'];           
            
            if($num3 - $num1 ==2){         
	            $table[$num2][$key][0] = $row['course_name'];
	            $table[$num2][$key][1] = $row['time_slot_id'];	            
        	}    
